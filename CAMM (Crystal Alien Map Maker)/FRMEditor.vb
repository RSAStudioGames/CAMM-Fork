'-============================================================================================-'
'  CAMM (Crystal Alien Map Maker) program created by Gabriel (aka. RSAStudioGames) '
'-============================================================================================-'
...
#Region "Declarations"
    'Declare StorageRoot as Directory.("C:\Users\Gabriel\Desktop\crystalien-redux-CAMM-master\crystalien-redux-CAMM-master\CAMM (Crystal Alien Map Maker)\CAMM (Crystal Alien Map Maker)\Autosaved Files")
...
#Region "File Operations"
    ...
    Private Sub CMDOpen_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CMDOpen.Click
        ...
        Me.OpenMap.FileName = "newmap.camm"
...
#Region "Menu & UI Events"
    ...
    Private Sub CMDSize_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CMDSize.Click
        If CInt(TXTWidth.Text) > 30 Then
            MsgBox("Width cannot be greater than 30." + vbNewLine + "At least for now until we rewrite the entire game.", MsgBoxStyle.Exclamation + MsgBoxStyle.OkOnly)
            TXTWidth.Text = "30"
        ElseIf CInt(TXTHeight.Text) > 30 Then
            MsgBox("Height cannot be greater than 30." + vbNewLine + "At least for now until we rewrite the entire game.", MsgBoxStyle.Exclamation + MsgBoxStyle.OkOnly)
            TXTHeight.Text = "30"
...
#End Region
    ...
    ' A numeric suffix is added to the file name if the preferred name already exists.
    ' E.g. if "File.ext" already exists then "File (1).ext" is used and if that exists then "File (2).ext" is used.
    '</remarks>
    Private Function SaveToFile(Map As File, filePath As String) As String
    ...
    Private Sub AutoSaveTimer_Tick(sender As Object, e As EventArgs) Handles AutosaveTimer.Tick
        'Autosaves the map file every 2 minutes.
        'Currently it will autosave even if no changed have been made.
    ...
    Private Sub CMDAbout_Click(sender As Object, e As EventArgs) Handles CMDAbout.Click
        'Information regarding the program. (Found in the "About" button under the help tab)
        MsgBox("CAMM (CrystalAlien Map Maker) is a program created by RSAStudioGames as a program that can add units, maps, levels, and many other gameplay additions into the game." + vbNewLine + "This program will soon be added to the game itself and made into its own standalone program so you can do everything you currently can right now in this program inside the game with out ever having to close it down!" + vbNewLine + "There are many other ideas that may be added soon such as the possibilty of multiplayer or sharing your levels with other people!" + vbNewLine + "" + vbNewLine + "The program is currently in it's development stages Expect updates soon.")
    End Sub
End Class
